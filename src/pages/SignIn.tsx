      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-sm border border-[#5C3D2E]/10 p-8">
            <h2 className="text-3xl font-bold text-[#5C3D2E] mb-2">Welcome back</h2>
            <p className="text-gray-500 mb-8">Your family's stories are waiting.</p>
            ...
            <p className="text-center text-gray-500 mt-6">
              ...
              <Link to="/signup" className="text-[#C8860A] font-semibold hover:underline">
                Create one
              </Link>
            </p>
          </div>
